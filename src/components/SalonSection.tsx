      ...
      <div className="container max-w-6xl mx-auto">
        ...
        >
          <span className="text-primary font-semibold text-sm tracking-widest uppercase">
            <Sparkles className="inline w-4 h-4 mr-1" /> Beauty & Salon
          </span>
          <h2 className="section-title mt-2">Salon Services</h2>
          <p className="section-subtitle mt-3">Professional makeup & grooming for your special day</p>
        </motion.div>
