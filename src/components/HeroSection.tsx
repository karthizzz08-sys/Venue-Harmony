    ...
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-primary-foreground/90 font-display text-xl md:text-2xl italic mb-2">
            A/C Wedding Hall
          </p>
          <p className="text-primary-foreground/70 font-body text-base md:text-lg mt-6 max-w-xl mx-auto">
            Your dream wedding, our grand venue. Complete packages for halls, photography, decoration & events.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <a
            href="#gallery"
            className="border-2 border-primary-foreground/30 px-8 py-4 rounded-full text-primary-foreground font-semibold text-lg hover:bg-primary-foreground/10 transition-colors"
          >
            View Gallery
          </a>
        </motion.div>
