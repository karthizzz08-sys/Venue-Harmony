...
export const decorationItems: DecorationItem[] = [
  ...
  { id: 'stage-grand', name: 'Grand Stage Decoration', price: 12000, description: 'Luxury full-stage décor with lighting', icon: '👑' },
  ...
  { id: 'car-decor', name: 'Grand & simple decortion', price: 15000, description: 'Beautiful car décor with flowers & ribbons', icon: '🚗' },
  { id: 'mandapam-floral', name: 'Reception Setup', price: 18000, description: 'Traditional mandapam with fresh flowers', icon: '🌺' },
  { id: 'reception-decor', name: 'Birthday Hall Décor', price: 18000, description: 'Full reception hall decoration with drapes & lights', icon: '✨' },
